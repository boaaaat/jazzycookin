...
public enum KitchenSourceProfile implements StringRepresentable {
    ...
    ROOT_VEGETABLE_PATCH("root_vegetable_patch", true, 5, 4, 7, true),
    LEAFY_GREENS_BED("leafy_greens_bed", true, 4, 3, 6, true),
    PEPPER_BUSH("pepper_bush", true, 5, 4, 8, true),
    PEA_TRELLIS("pea_trellis", true, 5, 4, 8, true),
    CITRUS_SAPLING("citrus_sapling", true, 6, 5, 8, true),
